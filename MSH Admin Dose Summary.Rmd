...
dept_mappings <- read_excel(paste0(user_directory, "/Reference File Apr 2022/",
                                   "MSHS COVID-19 Vaccine Department Mappings 2022-04-05.xlsx"))
...
sched_to_date <- sched_to_date %>%
  mutate(
    ...
    Site = ifelse(Site %in% c("MSB") & Mfg %in% c("Moderna"), "MSH",
...
kable(subset_data,
      ...
      align = "l",
      digits = 0,
      caption = paste("MSHS", setting, vax_type,
