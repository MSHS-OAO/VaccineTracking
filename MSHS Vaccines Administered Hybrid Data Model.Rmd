...
vax_admin_repo_summary <- readRDS(
  paste0(user_directory,
         "/Hybrid Repo Sched & Admin Data",
         "/Vaccine Administration Daily Summary 01012022 to 09102022 as of 2022-09-14.RDS"))
...
if (update_repo) {
  ...
  weekly_vax_admin <- read.csv(weekly_vax_admin)
  ...
  # Save new repository
  saveRDS(sched_repo, paste0(user_directory, "/Epic Vaccines Administered Report/",
